...
$ch  = __DIR__ . DIRECTORY_SEPARATOR . "lists" . DIRECTORY_SEPARATOR . "channels" . DIRECTORY_SEPARATOR;
$cat = null;
...
if ($cat){
?>
<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" onclick="_open('canais.php');">
	Voltar
</button>
<br/>
<br/>
...
<table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp">
	...
	<tbody>
		...
		sort($dirs);
		foreach ($dirs as $dir) {
			?><tr><td onclick="_open('canais.php?cat=<?php echo urlencode($dir);?>')" class="mdl-data-table__cell--non-numeric"><?php echo $dir;?></td></tr><?php
		}
		?>
	</tbody>
</table>
